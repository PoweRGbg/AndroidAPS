...
class APSCurvesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        openapsma_run.setOnClickListener {
            APSCurvesPlugin.getPlugin().invoke("APSCurve button", false)
        }
    }
    ...
    fun updateGUI() {
        ...
        val plugin = APSCurvesPlugin.getPlugin()
        ...
        plugin.lastDetermineBasalAdapterCurvesJS?.let { determineBasalAdapterSMBJS ->
